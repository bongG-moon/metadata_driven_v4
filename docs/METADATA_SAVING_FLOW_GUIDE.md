...
flowchart LR
  ...
  Existing["Existing Metadata Loader (optional)"] --> AuthorPrompt["Saving Prompt"]
...
2. 2단계 확인 flow
   ...
   - 사용자가 선택한 action과 `pending_saving_payload`를 2차 저장 flow에 넘긴다.
...
-> 00 Saving Request Loader.existing_items
00 Saving Request Loader.payload_out
...
03 Saving Variables Builder.existing_metadata_summary
-> Langflow Prompt Template: 03_saving_prompt_template_ko.md.existing_metadata_summary
03 Saving Variables Builder.refined_text
-> Langflow Prompt Template: 03_saving_prompt_template_ko.md.refined_text
```

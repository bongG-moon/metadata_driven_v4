...
def build_variables(payload_value: Any) -> dict[str, Any]:
    ...
    review_input = {"metadata_type": "main_flow_filter", "items": payload.get("items", []), "conflict_warnings": payload.get("conflict_warnings", [])}
...
class MainFlowFilterReviewVariablesBuilder(Component):
    display_name = "06 메인 플로우 필터 검수 변수 생성기"

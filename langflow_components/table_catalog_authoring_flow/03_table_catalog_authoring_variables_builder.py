...
def build_variables(payload_value: Any) -> dict[str, Any]:
    ...
    return {"refined_text": payload.get("refinement", {}).get("refined_text", ""), "existing_metadata_summary": json.dumps(existing_summary[:50], ensure_ascii=False, indent=2), "metadata_type": "table_catalog"}

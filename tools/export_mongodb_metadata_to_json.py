...
EXPORT_FORMAT = "metadata_driven_v4.mongodb_metadata_bundle.v1"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Export metadata-driven v4 MongoDB metadata collections to a portable JSON bundle.")
